...
/// Azure SQL管理员账户仓储实现
/// </summary>
public class AzureSqlTealvAdminAccountRepository : ITevlaAdminAccountRepository
{
    private readonly string _connectionString;
    private readonly string _tableName;
    private readonly ILogger<AzureSqlTealvAdminAccountRepository> _logger;

    /// <summary>
    /// 初始化 Azure SQL 管理员账户仓储
    /// </summary>
    /// <param name="options">配置选项</param>
    /// <param name="logger">日志记录器</param>
    public AzureSqlTealvAdminAccountRepository(
        IOptions<TealvOptions> options,
        ILogger<AzureSqlTealvAdminAccountRepository> logger)
    {
