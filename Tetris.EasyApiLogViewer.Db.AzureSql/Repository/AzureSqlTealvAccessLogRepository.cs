...
namespace Tetris.EasyApiLogViewer.Db.AzureSql.Repository;

/// <summary>
/// Azure SQL访问日志仓储实现
/// </summary>
public class AzureSqlTealvAccessLogRepository : ITealvAccessLogRepository
{
    private readonly string _connectionString;
    private readonly string _tableName;
    private readonly ILogger<AzureSqlTealvAccessLogRepository> _logger;

    /// <summary>
    /// 初始化 Azure SQL 访问日志仓储
    /// </summary>
    /// <param name="options">配置选项</param>
    /// <param name="logger">日志记录器</param>
    public AzureSqlTealvAccessLogRepository(
        IOptions<TealvOptions> options,
        ILogger<AzureSqlTealvAccessLogRepository> logger)
    {
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken = default)
    {
        ...
        _logger.LogInformation("Azure SQL {TableName} table initialized", _tableName);
    }
    ...
    public async Task<int> PurgeOldLogsAsync(int retentionDays, CancellationToken cancellationToken = default)
    {
        ...
        _logger.LogInformation("Purged {Count} old access logs from Azure SQL", deletedCount);
