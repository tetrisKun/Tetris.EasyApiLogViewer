...
/// MySQL管理员账户仓储实现
/// </summary>
public class MySqlTealvAdminAccountRepository : ITevlaAdminAccountRepository
{
    private readonly string _connectionString;
    private readonly string _tableName;
    private readonly ILogger<MySqlTealvAdminAccountRepository> _logger;
    ...
    public MySqlTealvAdminAccountRepository(
        IOptions<TealvOptions> options,
        ILogger<MySqlTealvAdminAccountRepository> logger)
    {
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken = default)
    {
        ...
        var createTableSql = $@"
            ...
            (
                ...
                PRIMARY KEY (`Id`),
                UNIQUE KEY `UQ_{_tableName}_Username` (`Username`)
